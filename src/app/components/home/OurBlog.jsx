...
export default function OurBlog() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 mx-4 md:mx-10 lg:mx-45 my-35 overflow-hidden">
      ...
      >
        <h1 className="text-gray-500 text-2xl font-bold">TableWare</h1>
        <h1 className="font-garamond mt-3 font-extrabold text-2xl sm:text-3xl md:text-4xl leading-tight uppercase">
          The secrets to a kitchen rooms
        </h1>
