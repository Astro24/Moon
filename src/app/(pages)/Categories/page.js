    ...
    <div>
      ...
      <section className="categories-cards-section">
        <div className="category-card">
          <img src="/Bitmap.svg" alt="Tableware" />
        ...
        <div className="category-card">
          <img src="/Bitmap (1).svg" alt="Holiday" />
          <div className="category-card-content">
            <h2>Holiday</h2>
        ...
        <div className="category-card">
          <img src="/Bitmap (2).svg" alt="Home Decor" />
          <div className="category-card-content">
            <h2>Home Decor</h2>
      ...
      <section className="categories-cards-section">
        <div className="category-card">
          <img src="/Bitmap (3).svg" alt="Tableware" />
          <div className="category-card-content">
            <h2>Collection</h2>
        ...
        <div className="category-card">
          <img src="/Bitmap (4).svg" alt="Holiday" />
          <div className="category-card-content">
            <h2>Dinner Sets</h2>
        ...
        <div className="category-card">
          <img src="/Bitmap (5).svg" alt="Home Decor" />
          <div className="category-card-content">
